...
const ToTheAirport = ({isMobile, resultsData}) => {
    ...
    return (
        <Grid container item direction={isMobile} justify="center" alignItems="center" spacing={1}>
            ...
            <Grid item md={4}>
                <Typography className={classes.text}><strong>Getting Too The Airport and Back</strong></Typography>
            </Grid>
            <Grid item md={4}>
                <Typography className={classes.text}>The cheapest option is by {resultsData.vehicle}</Typography>
            </Grid>
            <Grid item>
                <Typography 
